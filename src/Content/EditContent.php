...
class EditContent implements AppInjectableInterface
{
    ...
    * @var BlogHandler  $blogHandler database handler
     ...
     *
     * @throws NotFoundException when the database id is not numeric
     *
    ...
    public function editActionGet($id) : object
    {
        ...
        // $this->app->page->add("content/flash", [], "flash");
    ...
    public function resetActionPost() : object
    {
        ...
        $this->app->page->add("content/edit-header");
        $this->app->page->add("content/echo", $data);
    ...
    public function pageActionGet($path = null) : object
    {
        if (!$path) {
            // Page is not set
            $data = [
                "output" => "<p>Path to page is not set!</p>"
            ];
            $this->app->page->add("content/edit-header");
            $this->app->page->add("content/echo", $data);
            return $this->app->page->render([
    ...
    /**
     * This method handles a non existing route:
     * ANY METHOD mountpoint/**
     *
